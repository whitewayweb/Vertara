...
| Opening hook | Optional opening text with bounded duration, font size, placement, and background colour. Blank hooks are not exported. | `features/project/hook-settings.ts`, `components/molecules/video-hook-overlay.tsx` | Yes |
