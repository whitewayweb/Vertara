...
export function ExportPanel({ canvasLayout, focusLayout, mode, playback, posterLayout, sourceUrl }: ExportPanelProps) {
  ...
  async function handleExport() {
    ...
    try {
      const file = await exportLocalMp4({ abortSignal: abortController.signal, canvasLayout, focusLayout, mode, onProgress: setProgress, output: outputPresets[preset], playback, posterLayout, sourceUrl });
