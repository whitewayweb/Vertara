...
- [x] Add reusable Text, Hook, Quote, and CTA text templates through an Add text menu docked at the preview’s top-right; selected layers show type-relevant controls in the existing contextual right inspector and an aligned text timing lane, alongside duplicate/delete actions.
